...
public class CircleService implements GeneralCircle{
    ...
    public  boolean intersectCircle(Circle circle1, Circle circle2){
        return ((Math.abs(circle1.getCenter().getX() - circle2.getCenter().getX())) <= Math.abs(circle1.getRadius())
                + Math.abs(circle2.getRadius())) &&
                ((Math.abs(circle1.getCenter().getY() - circle2.getCenter().getY())) <= Math.abs(circle1.getRadius())
                + Math.abs(circle2.getRadius()));
    }
